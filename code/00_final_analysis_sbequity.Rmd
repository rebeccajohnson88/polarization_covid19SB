...
dist_rank_plot
ggsave("../output/figs/rankings_count_3groups.png",
       plot = dist_rank_plot,
       width = 12,
       height = 8) 
...
prop_choose_plot
ggsave("../output/figs/rankings_prop_2groups.png",
...
ggsave("../output/figs/rankings_prop_3groups.png",
...
ggsave("../output/figs/rankings_prop_3groups_wpoliticalaffil.png",
...
ggsave("../output/figs/rankings_prop_3groups_wpoliticalaffil_excludeother.png",
...
ggsave("../output/figs/among_points_timedist.png",
       plot = time_plot,
       width = 12,
       height = 8) 
...
stargazer(lm(points_rank ~ is_any_barriers,
          ...
          lm(is_points_first ~ is_any_barriers,
           data = model_df),
          type = "html",
          out="../output/tables/maineffect_regs.doc")
...
stargazer(lm(points_rank ~ cond,
          ...
          lm(is_points_first ~ cond,
           data = barriers_r),
          type = "html",
          out="../output/tables/womenvmob_barriers_regs.doc")
...
ggsave("../output/figs/jw_prediction.png",
...
ggsave("../output/figs/pol_prediction.png",
...
write.table(prop_themes_all, 
    file = "../output/tables/overall_fr_themes.txt",
    sep = ",", quote = FALSE, row.names = F)
write.csv(prop_themes_all, 
    file = "../output/tables/overall_fr_themes.csv",
...
write.table(prop_by_cond, 
    file = "../output/tables/themes_by_treatcondition.txt",
    sep = ",", quote = FALSE, row.names = F)
write.csv(prop_by_cond, 
    file = "../output/tables/themes_by_treatcondition.csv",
     quote = FALSE, row.names = F)
...
write.table(prop_by_rank, 
    file = "../output/tables/themes_by_pointsranking.txt",
    sep = ",", quote = FALSE, row.names = F)
write.csv(prop_by_rank, 
    file = "../output/tables/themes_by_pointsranking.csv",
     quote = FALSE, row.names = F)
...
ggsave("../output/figs/prop_frthemes_byrank.png",
       plot = last_plot(),
       width = 12,
       height = 8) 
...
ggsave("../output/figs/prop_frthemes_byrank_byideology.png",
       plot = last_plot(),
       width = 12,
       height = 8) 
```
...
prop_choose_plot_nd
ggsave("../output/figs/rankings_prop_2groups_excludedemand.png",
...
ggsave("../output/figs/rankings_prop_3groups_nd.png",
...
ggsave("../output/figs/rankings_prop_3groups_wpoliticalaffil_nd.png",
...
ggsave("../output/figs/jw_poli_ideo_plot.png",
...
ggsave("../output/figs/jw_poli_affil_plot.png",
